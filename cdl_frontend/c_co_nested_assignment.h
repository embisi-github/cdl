...
public:
    ...
    c_co_nested_assignment( int wildcard, class c_co_expression *expression );
    ...
    // expression <expr>, symbol null, nested_assignment null, chain '..' => '{ *=e, .. }'

    int wildcard; // true if a wildcard expression, in which case ALL children should be assigned to the expression
