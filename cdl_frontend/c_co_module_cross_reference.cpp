...
void c_co_fsm_state::cross_reference( class c_cyclicity *cyclicity, t_co_scope *types, t_co_scope *variables )
{
     ...
     if (expression)
     {
          ...
          has_expression = 1;
          // FIXME fprintf(stderr, "**** WARNING - expressions given to FSM declarations are NOT checked for being suitably in range or one-hot; please do not specify values for states in FSMs unless absolutely required\nNYI:c_co_fsm_state::cross_reference:Expressions not typechecked yet\n");
     }
